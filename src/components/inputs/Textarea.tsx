...
export default function Textarea({ id, label, ...props }: TextareaProps) {
  return (
    <div className="flex flex-col w-full">
      ...
      <textarea id={id} className="w-full outline-none border-b-[1px] text-[var(--color-dark-blue)] border-b-[var(--color-dark-gray)] py-1 resize-none min-h-20" rows={1} {...props}></textarea>
    </div>
  )
}